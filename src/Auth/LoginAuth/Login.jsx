...
const index = () => {
  return (
    <>
      <div className="login-wrapper relative min-h-screen flex items-center flex-col justify-center bg-gradient-to-br from-indigo-500 to-pink-500 overflow-hidden">
        ...
        <form className="login-form relative bg-white p-8 rounded-lg shadow-lg w-full max-w-md">
          ...
          <button
            type="submit"
            className="submit-login  px-6 py-2 text-white font-semibold 
